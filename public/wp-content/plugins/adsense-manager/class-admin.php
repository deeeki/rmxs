		...
		function init_admin()
		{
			...
			if (adsensem::setup_is_valid()==false){ //No startup data found, fill it out now.
				...
				$update_adsensem = true; 
                    ...
                    // Check we are at least on 2.5
                    if(adsensem_admin::version_upgrade("2.4.99",$wp_version) == true){ 
                        adsensem_admin::add_notice('notice adsense-manager','AdSense Manager is now being developed as <a href="http://wordpress.org/extend/plugins/advertising-manager/">Advertising Manager</a> for WordPress 2.5 and up. It is recommended you <a href="http://wordpress.org/extend/plugins/advertising-manager/">download and install</a> today!','ok');
                    } 
