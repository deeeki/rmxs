...
AdSense Manager is now Advertising Manager: wordpress.org/extend/plugins/advertising-manager. It is recommended you upgrade, unless you are using WordPress 2.5 or earlier.

== Description ==

AdSense Manager is now [Advertising Manager](http://wordpress.org/extend/plugins/advertising-manager/). It is recommended you upgrade, unless you are using WordPress 2.5 or earlier.

This version will remain available for download for all users of WordPress 2.5 and earlier. If you are are using an earlier version of AdSense Manager it is recommended you upgrade to this
version for bugfixes (it is known to be stable and relatively bug free). Thanks.
