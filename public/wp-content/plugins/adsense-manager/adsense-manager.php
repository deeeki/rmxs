...
Description: AdSense Manager has now been superseded by Advertising Manager and is a recommended upgrade if you are on WP2.5 or later. Please visit the Wordpress Extend site to download ASAP!
Author: Martin Fitzpatrick
Version: 3.3.3
Author URI: http://www.mutube.com/
*/
@define("ADSENSEM_VERSION", "3.3.3");

@define("AM_BRAND_NAME", "AdSense Manager");
@define("AM_BRAND_DEFAULT_NETWORK", "AdSense");
@define("AM_BRAND_ACTIVATE",'AdSense Manager is now being developed as <a href="http://wordpress.org/extend/plugins/advertising-manager/">Advertising Manager</a> for WordPress 2.5 and up. It is recommended you <a href="http://wordpress.org/extend/plugins/advertising-manager/">download and install</a> today!');
